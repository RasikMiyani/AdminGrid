...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create('Rasik\Contacts\Model\Contacts')->load($id);
            if (!$model->getId() && $id) {
    ...
    {
        return $this->_authorization->isAllowed('Rasik_Contacts::contacts_update') || $this->_authorization->isAllowed('Rasik_Contacts::contacts_create');
    }
}
