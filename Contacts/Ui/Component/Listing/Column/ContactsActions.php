<?php
namespace Rasik\Contacts\Ui\Component\Listing\Column;
...
class ContactsActions extends Column
{
     ...
     * Url path
     */
    const URL_PATH_EDIT = 'rasik_contacts/contacts/edit';
    const URL_PATH_DELETE = 'rasik_contacts/contacts/delete';
